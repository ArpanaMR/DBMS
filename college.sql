...
('1RN13CS091','10CS81','CSE8C', 15, 16, 18,19);
INSERT INTO IAMARKS (USN, SUBCODE, SSID, TEST1, TEST2, TEST3,FINALIA) VALUES
('1RN13CS091','10CS82','CSE8C', 12, 19, 14,20);
INSERT INTO IAMARKS (USN, SUBCODE, SSID, TEST1, TEST2, TEST3,FINALIA) VALUES
('1RN13CS091','10CS83','CSE8C', 19, 15, 20,13);
INSERT INTO IAMARKS (USN, SUBCODE, SSID, TEST1, TEST2, TEST3,FINALIA) VALUES
('1RN13CS091','10CS84','CSE8C', 20, 16, 19,15);
INSERT INTO IAMARKS (USN, SUBCODE, SSID, TEST1, TEST2, TEST3,FINALIA) VALUES
('1RN13CS091','10CS85','CSE8C', 15, 15, 12,16);
...
FROM STUDENT S, SEMSEC SE, CLASS C
WHERE S.USN = C.USN AND SE.SSID = C.SSID AND
SE.SEM = 4 AND SE.SEC='C';
...
/*3. Create a view of Test1 marks of student USN ‘1RNCS091’ in all subjects.*/

CREATE VIEW TEST1MARKS
AS
SELECT TEST1, SUBCODE,SSID
FROM IAMARKS
